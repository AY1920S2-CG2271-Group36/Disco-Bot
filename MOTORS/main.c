...
#define PERIOD				0.02
#define CORE_PERIOD		(2.67*pow(10, -6))  // Prescalar 128

#define PTB0_Pin 0
#define PTB1_Pin 1

// TPM0_CH0 (Front Left)
#define PTD0_Pin 6 												// AIN1
#define PTC1_Pin 12												// AIN2

// TPM0_CH1 (Front Right)
#define PTD1_Pin 12												// BIN1
#define PTC2_Pin 10												// BIN2

// TPM0_CH2 (Rear Left)
#define PTD2_Pin 8												// AIN1
#define PTC3_Pin 5												// AIN2

// TPM0_CH3 (Rear Right)
#define PTD3_Pin 10												// BIN1
#define PTC4_Pin 7												// BIN2
...
void startFL(float dutyCycle) {
	TPM0_C0V = numClkCycles * dutyCycle;
}

void startRL(float dutyCycle) {
	TPM0_C1V = numClkCycles * dutyCycle;
}

void startFR(float dutyCycle) {
	TPM0_C2V = numClkCycles * dutyCycle;
}

void startRR(float dutyCycle) {
...
void moveForward() {
	startPWM();
	startFL(FORWARD_DUTY_CYCLE);
	startRL(FORWARD_DUTY_CYCLE);
	startFR(FORWARD_DUTY_CYCLE);
	startRR(FORWARD_DUTY_CYCLE);
}
